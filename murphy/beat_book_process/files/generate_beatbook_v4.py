...
# Output file
OUTPUT_FILE = BASE_DIR / "beatbook_v4.md"
...
Using the "Most-Mentioned Officials/Figures" from Story Coverage and the officials in Verified Facts:

Create a narrative section (NOT just a table) organized into these categories:

**County Leadership (150 words)**
- List commissioners/council members from Verified Facts
- For each person, note:
  - How many stories mentioned them (from Story Coverage)
  - Policy areas they're associated with (from minutes and stories)
  - Whether they vote with the majority or dissent
  - Contact info if available

**Municipal Leaders (100 words)**
- Highlight mayors who appear frequently in stories or minutes
- Note which municipalities get the most coverage
- Explain their relationship to county government

**Staff & Appointed Officials (100 words)**  
- County administrator, department heads mentioned in stories
- Note if they appear as sources in multiple stories
- Explain their role in policy implementation

**External Stakeholders (100 words)**
- State legislators representing the county
- Advocacy group leaders mentioned in stories
- Business/development figures appearing in multiple stories
- Agency directors (health department, planning, etc.)

**Media Contacts (50 words)**
- Which reporters cover this county most frequently (from story authors)
- Note their beat focus if evident

After each category, write 1-2 sentences explaining patterns you see (e.g., "Commissioner X appears in 15 stories but never in minutes, suggesting media access without public-meeting participation").

Format as prose with embedded details, not as a dry table.
""",
        10: """
...
- Transparency gaps (issues covered in media but not debated in meetings)

Then write 2 paragraphs (120 words each):

**Paragraph 1: Highest-Priority Investigations**
Identify the top 3 red flags reporters should investigate first. Explain why these are urgent and what specific records/interviews to pursue.

**Paragraph 2: Coverage Gaps**
Compare story coverage to meeting minutes: What major budget/policy issues got NO media coverage? What issues appear in stories but never reached the official agenda? Why might this be?

Use ONLY concerns documented in Budget Insights, Meeting Minutes, or evident from comparing official actions to story coverage patterns.
""",
        11: """
